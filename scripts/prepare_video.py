...
from src.config import TEST_VIDEOS_DIRECTORY, DEFAULT_TRAINED_MODEL_NAME, DEFAULT_YT_VIDEO_URL, MODELS_DIR, MODEL_FORMAT, GPU_USED
...
def get_prepared_params():
    ...
    video_title, videofile_path, display_title = download_youtube_video(DEFAULT_YT_VIDEO_URL, TEST_VIDEOS_DIRECTORY)
    print(f'Video {display_title} was downloaded to {TEST_VIDEOS_DIRECTORY}')
    ...
    model_path = os.path.join(MODELS_DIR, learned_model_name, f'model.{MODEL_FORMAT}')
